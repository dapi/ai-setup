...
RSpec.describe Operations::Tickets::CompleteService do
  describe ".call" do
    ...
    it "completes an assigned in-progress ticket" do
      ticket = create(:ticket, hotel: hotel, department: department, staff: staff_user, status: :in_progress)
    ...
    it "denies unassigned tickets" do
      ...
      ticket = create(:ticket, hotel: hotel, department: other_department, staff: nil, status: :in_progress)
    ...
    it "denies same-department unassigned tickets" do
      ticket = create(:ticket, hotel: hotel, department: department, staff: nil, status: :in_progress)
    ...
    it "denies non-staff actors" do
      ...
      ticket = create(:ticket, hotel: hotel, department: department, staff: manager, status: :in_progress)
    ...
    it "denies invalid transitions" do
      ...
      expect(result).to be_failure
      expect(result.messages).to include("Ticket cannot be completed")
