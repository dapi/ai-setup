...
func (m *MockRepository) GetByID(arg0 context.Context, arg1 uuid.UUID) (*post.Post, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) List(arg0 context.Context, arg1 post.ListFilter) ([]post.Post, int, error) {
	m.ctrl.T.Helper()
