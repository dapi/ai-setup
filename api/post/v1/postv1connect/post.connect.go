...
const (
	...
	PostServiceListPostsProcedure = "/post.v1.PostService/ListPosts"
)
...
func NewPostServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PostServiceClient {
	...
	postServiceMethods := v1.File_api_post_v1_post_proto.Services().ByName("PostService").Methods()
...
// ListPosts calls post.v1.PostService.ListPosts.
...
func (UnimplementedPostServiceHandler) ListPosts(context.Context, *connect.Request[v1.ListPostsRequest]) (*connect.Response[v1.ListPostsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("post.v1.PostService.ListPosts is not implemented"))
}
